          ...
          <Animated.View style={[animatedStyle]}>
            ...
            >
              <View
                style={[
                  depth > 1 && styles.side,
                  { borderLeftColor: depthToColor(depth) },
                ]}
              >
                <Pressable onPress={() => setCollapsed(!collapsed)}>
                  <VStack flex={1} space={1} alignItems="flex-start">
                    <Text fontWeight="bold">
                      {`${truncateName(comment.top.creator.name)}${
                        showInstanceForUsernames
                          ? `@${getBaseUrl(comment.top.creator.actor_id)}`
                          : ""
                      }`}
                    </Text>
                    <HStack space={3} alignItems="center">
                      ...
                      <HStack space={1} alignItems="center">
                        ...
                        <Text color="gray.500">
                          {moment(comment.top.comment.published)
                            .utc(true)
                            .fromNow()}
                        </Text>
                      </HStack>
                    ...
                    {!collapsed ? (
                      <Text>
                        {comment.top.comment.deleted ||
                        comment.top.comment.removed ? (
                          ...
                          <VStack pr={2}>
                            <RenderMarkdown
                              text={comment.top.comment.content}
                              addImages
                            />
                          </VStack>
                        )}
